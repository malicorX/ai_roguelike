...
- **Proposal lint:** Builder proposals must reference real repo paths or explicitly mark new files, must not claim tests ran while the loop is still proposal-only, and must recommend only known test commands.
